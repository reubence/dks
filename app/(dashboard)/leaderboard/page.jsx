      ...
      <main className="md:w-full border rounded-lg bg-primary px-4 lg:px-6">
        <Tabs defaultValue="all" className="mt-9">
          ...
          <TabsContent className="" value="all">
            <ScrollArea className="w-[calc(100vw-60px)] lg:w-full md:h-[calc(100vh-450px)] lg:h-[calc(100vh-370px)] tallXS:h-56">
              <Table>
                <TableHeader>
                  <TableRow>
                ...
                <TableBody className="">
                  {invoices.map((invoice, i) => (
                    ...
                    >
                      ...
                      <TableCell className="flex gap-3.5 items-center whitespace-nowrap w-[350px] sm:w-full">
                        {invoice.name}
                        {i == 0 && (
                          <Image
                            src={DKS_GOLD}
